...
<body>
	...
	<div id="content">
		...
		<div id="con2">
			<form method="post" id="form1" action="user/register"
				style="display: block;">
				<div id="shoujidiv">
					<span id="span1"><i id="spani">*</i>手机：</span> <span id="guoqi"
						class="color1"></span>
					<div id="number" class="color1">
						<span id="diquhao">+86</span> <input type="text" name="userid"
							placeholder="请输入您的手机号" id="shouji" />
					</div>

					<span id="shoujits1" style="display: none;">请输入您的手机号码</span> <span
						id="shoujits2" style="display: none;">手机号长度11位，以13/14/15/17/18开头</span>
					<span id="shoujits3" style="display: none;">请输入手机号码</span> <span
						id="shoujits4" style="display: none;"></span>
				</div>

				<div id="mimadiv">
					<span id="span2"><i>*</i>设计密码：</span> <input type="password"
						name="upwd" id="pwd" class="color1" /> <span id="mimats1"
						style="display: none;">请输入6-16位数字、字母或常用符号，字母区分大小写</span> <span
						id="mimats2" style="display: none;">请输入密码</span> <span
						id="mimats3" style="display: none;"><span class="sp1">弱：</span>你输入的密码强度过弱，请重新输入，试试字母、数字、常用符号的组合</span>
				...
				<div>
					<a href="page/visitor.jsp"><input type="submit" value="立即注册" id="sub" /></a>
				</div>

				<a href="">微博服务使用协议</a><br /> <a href="">微博个人信息保护政策</a><br /> <a
					href="">全国人大常委会关于加强网络信息保护的决定</a><br />
			</form>

			<img src="images/reg_vline.png" />
			<div id="con3">
				<div id="cont3">
					已有帐号，<a href="page/login.jsp">直接登录>></a>
				</div>
				<p>微博注册帮助</p>
				<ul>
