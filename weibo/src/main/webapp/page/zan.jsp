	...
	<div id="content">
		...
		<div class="content_middle">
			<div class="content1">
				...
				<a href="" id="coll1" class="sub1">我的赞<small
					style="font-weight: 200">（共<span>0</span>条）
				</small></a>

				<div id="content1_1" class="color1">
					<input type="text" name="look" placeholder="查找我赞的微博" /> <a href=""
						id="coll3"><em style="color: #696E78; font-size: 15px;">f</em></a>
				</div>
				...
				<div class="conted1" style="display: none;">
					...
					<div class="contedbtn">
						<input type="button" value="去热门微博看看" id="conbtn1" /> <input
							type="button" value="我知道了" id="conbtn2" />
					</div>
				...
				<div class="content2" style="display: block;"><br/><br/>
					<!--	 <div class="contentd2" style="display: block;">
           			<p class="content2_1"><span class="content2_4"></span></p>
	           		<p class="content2_2">你还没有点赞任何微博呢！</p>
	           		<p class="content2_3">当你发现有意思的、有趣的微博时，就赞一下哦！</p>
           		</div> -->
					</div><br/><br/>
			...
			<div class="content_right">
				<div class="content4">
					<a href="http://apps.weibo.com/ynotefavorite"> <span
						class="content4_1"></span> 导出收藏夹至有道云笔记
					</a>
				</div>
				<div class="content5">
					...
					<dl class="content5_2">
						<dt class="content5_3">
							<em class="content5_31">9</em> <span class="content5_32">：为什么要收藏微博？</span>
						</dd>
						<dd class="content5_4">
							<span class="content5_41">A</span> <span class="content5_42">：微博变化太快，看到好东西，还不赶快收藏下来！</span>
						</dt>
						<dt class="content5_3">
							<em class="content5_31">9</em> <span class="content5_32">：为什么要给收藏的微博加标签？</span>
						</dd>
						<dd class="content5_4">
							<span class="content5_41">A</span> <span class="content5_42">：加标签方便日后查找，同时系统也可以根据你的喜好进行微博推荐哦！</span>
						</dt>
					</dl>
			...
			<div class="foot-bottom">
				<div class="notice">
					<a href=""><img src="images/foot-wb-logo.png" />微博客服</a> <a
						...
						href="" class="a2">新浪网导航</a> <a href="" class="a2">举报处理大厅</a> <select>
						<option>中文(简体)</option>
						<option>中文(繁体)</option>
						<option>中文(香港)</option>
